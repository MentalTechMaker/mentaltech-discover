...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-280px)] px-4 py-8 md:py-12">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 mb-12">
        <div className="space-y-4">
          ...
          <p className="text-lg md:text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
            ...
            <strong>solutions digitales</strong> adaptées à vos besoins en santé mentale
          </p>
        </div>

        {/* Key Benefits - More visible */}
      ...
      {/* How it works - Improved visual hierarchy */}
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          ...
          >
            <div className="absolute top-4 right-4">
              <div className="bg-primary bg-opacity-10 text-primary px-3 py-1 rounded-full text-xs font-bold">
                INDIVIDUEL
              </div>
            </div>
          ...
          >
            <div className="absolute top-4 right-4">
              <div className="bg-secondary bg-opacity-10 text-secondary px-3 py-1 rounded-full text-xs font-bold">
                ENTREPRISE
              </div>
            </div>
            <div className="flex items-center gap-4">
