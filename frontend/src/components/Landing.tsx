...
export const Landing: React.FC = () => {
  ...
  useEffect(() => {
    getPublicStats()
      .then(setPublicStats)
      .catch(() => {
        /* silently ignore if stats unavailable */
      });
  }, []);
      ...
      <div className="px-4 py-8 md:py-12">
        <div className="max-w-5xl mx-auto text-center space-y-8 mb-12">
          <div className="space-y-4">
            ...
            <p className="text-lg md:text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              ...
              <strong>solutions numériques</strong> adaptées à vos besoins en
              santé mentale
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div
              className="relative bg-gradient-to-br from-green-50 to-white p-8 rounded-2xl border-3 border-gray-200 text-left space-y-4 opacity-60"
              aria-label="Parcours entreprise bientôt disponible"
            >
              <div className="absolute top-4 right-4">
            ...
            <div
              className="relative bg-gradient-to-br from-purple-50 to-white p-8 rounded-2xl border-3 border-gray-200 text-left space-y-4 opacity-60"
              aria-label="Parcours établissement bientôt disponible"
            >
              <div className="absolute top-4 right-4">
                <div className="bg-amber-100 text-amber-700 px-3 py-1 rounded-full text-xs font-bold">
                  BIENTÔT
              ...
              <p className="text-text-secondary text-base leading-relaxed">
                Je suis <strong>décideur de santé</strong> et cherche des
                solutions pour mon hôpital, clinique ou MSP
              </p>
              <div className="flex items-center gap-2 pt-4">
                <span className="text-gray-500 font-bold text-lg">
                  Bientôt disponible
          ...
          {publicStats &&
            (publicStats.prescribers > 0 || publicStats.prescriptions > 0) && (
              <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 py-4 mb-4">
                ...
                {publicStats.prescriptions > 0 && (
                  <div className="text-center">
                    <p className="text-3xl font-bold text-primary">
                      {publicStats.prescriptions}+
                    </p>
                    <p className="text-sm text-text-secondary">
                      prescriptions créées
                    </p>
                  </div>
                )}
                <div className="hidden md:block w-px h-10 bg-gray-200" />
